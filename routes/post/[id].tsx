...
/*
  * Cambiamos el metodo de axios "patch" por "post"
*/
interface Comment {
  _id: string;
  author: string;
...
export const handler: Handlers = {
  ...
  // Cambiamos los nombres de las variables al inglés (el mismo nombre que devuelve la API)
  async POST(req, ctx) {
    ...
    <div className="post-detail">
      ...
      <div className="post-container">
        ...
        <header className="post-header">
          {/* El titulo es post.title, no post.cover*/}
