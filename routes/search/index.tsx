...
/*
  * Ponemos correctamente la obtención de la URL, que ponía _req
  * Ahora mismo buscamos que el param sea "query", pero tiene que ser "search", se puede cambiar en cualquiera de los dos sitios
  * En la llamada a la API tambien ponemos query pero hay que poner search
*/
